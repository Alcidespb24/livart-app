...
const Map<EventCodes, String> EventCodeDatabase = {
  EventCodes.UNABLE_TO_SEND_PASSWORD_EMAIL:
  ...
  EventCodes.PASSWORD_TOO_WEAK:
      'This Password is too weak. Please Choose a stronger Password',
  EventCodes.USER_NOT_FOUND_INVALID_UNAME:
      'User not found. Please enter a valid user name',
  EventCodes.CREDENTIALS_IN_USE:
      'These credentials appear to be in use by another user. Please verify the email address provided',
  EventCodes.SIGN_IN_FAILED: 'Sign in Failed. Please try again',
  EventCodes.UNABLE_TO_WRITE_TO_DB:
      'Unable to write to the Database. Please try again later',
